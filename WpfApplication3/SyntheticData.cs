...
namespace Kalman_Filter
{
    public class SyntheticData
    {
        ...
        public SyntheticData()
        {
            ...
            processNoise.SetIdentity(new MCvScalar(1.5e-2)); //The smaller the value the more resistance to noise 
            measurementNoise = new Matrix<float>(2, 2); //Fixed accordiong to input data 
            measurementNoise.SetIdentity(new MCvScalar(1.0e-0)); //larger the value more resitance to noise and the less responsive to velocity
